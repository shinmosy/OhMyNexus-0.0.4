...
const { NeoxrApi: Api } = new(require('@lanbott/lanbot-js'))
...
module.exports = class NeoxrApi {
   ...
   tm = async (style, text) => {  
      let json = await Func.fetchJson(this.baseUrl + '/' + style + '?text=' + text + '&apikey=' + this.apiKey)
      return json
   }
   ...
   remini = async (image) => {
      let json = await Func.fetchJson(this.baseUrl + '/remini2?image=' + image + '&apikey=' + this.apiKey)
      return json
   }
   ...
   gdrive = async (url) => {
      let json = await Func.fetchJson(this.baseUrl + '/gdrive?url=' + encodeURIComponent(url) + '&apikey=' + this.apiKey)
      return json
   }

   capcut = async (url) => {
      let json = await Func.fetchJson(this.baseUrl + '/capcut?url=' + encodeURIComponent(url) + '&apikey=' + this.apiKey)
      return json
   }

   scrop = async (style, image) => {  
      const json = await Func.fetchJson(this.baseUrl + '/cropshape?style=' + style + '&image=' + image + '&apikey=' + this.apiKey)
      return json
   }
    
   bard = async (query) => {
       const json = await Func.fetchJson(this.baseUrl + '/bard?q=' + query + '&apikey=' + this.apiKey)
       return json
   }
}